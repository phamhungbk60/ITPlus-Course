            ...
            <div class="card-body">
                <div class="title d-flex justify-content-between align-items-center">
                    ...
                    <ul class="item-operations">
                        ...
                        <li><a href="javascript:void(0)" class="text-danger" onclick="deleteItem(this)" data-id="{{ $category->id }}">Delete</a></li>
                    </ul>
                </div>
                <hr/>
...
@push('js')
    <script>
        function deleteItem(e) {
            const confirmDeletePost = confirm('Bạn có chắc chắn muốn xoá category này')
