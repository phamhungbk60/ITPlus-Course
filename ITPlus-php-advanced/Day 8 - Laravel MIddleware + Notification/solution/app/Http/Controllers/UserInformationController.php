...
class UserInformationController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $originalFileName = md5(Carbon::parse(Carbon::now())->timestamp . "user-" . Auth::user()->id) . $avatar->getClientOriginalName();
        ...
        //lưu file vật lý với tên $originalFileName với disk avatar
        $avatar->storeAs(Auth::user()->id, $originalFileName, 'avatar');
